...
#ifndef TRAINANDTICKET_BNODEFORTICKET_H
#define TRAINANDTICKET_BNODEFORTICKET_H
//
...
struct internal_node{
    ...
    pair<Key, long> index[KEY_IN_INTER_TICKET];//there are indexes point to the next level.
};
...
struct leaf_node{//which contains some pair(key and value)
    ...
    pair<Key, Value> children[PAIR_IN_LEAF_TICKET];//how much pair    !!!there may be an error
...
#endif //TRAINANDTICKET_BNODEFORTICKET_H
